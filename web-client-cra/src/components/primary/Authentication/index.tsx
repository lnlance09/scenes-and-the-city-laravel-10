...
import { setSessionData } from "@utils/general"
...
const AuthenticationForm = ({
    ...
    const submitForgotPassword = async () => {
        ...
        const url = `${process.env.REACT_APP_API_BASE_URL}users/forgot`
        await axios
            .post(url, payload)
            .then(() => {
    ...
    const submitVerificationForm = () => {
        ...
        const formData: VerificationPayload = { code: verificationCode }
        const url = `${process.env.REACT_APP_API_BASE_URL}users/verify`
        axios
            .post(url, formData, {
                headers: {
    ...
    const authFooter = (text: string, linkText: string) => (
